...
export class LoginComponent implements OnInit {
  ...
  constructor(private network: NetworkService, private formBuilder: FormBuilder, private router: Router, private userService: UserService) { }
  ...
  submit(value) {
    const response = this.network.login(value).subscribe( data => {
      const aux: any = data;
      console.log(aux);
      this.userService.fillFields(value.username, aux.body.token, { type: aux.body.type , date: aux.body.date });
